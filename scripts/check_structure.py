...
def check_x86_libc_static_c_abi_boundary(errors: list[str]) -> None:
    ...
    for required in (
        ...
        "9fa28ece75d8a2191de7c5bb53bed224c5947417",
        "src/search/insque.c",
        "caller-owned first two pointer words",
    ...
    if exports != expected_exports:
        errors.append(
            ...
            "getopt state and aliases, standalone linear search, paired caller-owned intrusive queue rewiring, callback-tree/hash-table search, and the "
