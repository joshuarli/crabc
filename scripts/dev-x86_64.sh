...
case "$command" in
    ...
    math-exp2-header-abi|math-expm1-header-abi|math-log-header-abi|math-log10-header-abi|math-sin-header-abi|math-tan-header-abi|math-tanh-header-abi|libc-math-exp2|libc-math-expm1|libc-math-log|libc-math-log10|libc-math-sin|libc-math-tan|libc-math-tanh) ;;
