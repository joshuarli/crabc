...
Native Linux/x86-64 staged-foundation evidence commands:
  ...
  nameser-header-abi  verify staged x86 resolv.h C/C++ nameser helpers and _ns_flagdata data declaration
