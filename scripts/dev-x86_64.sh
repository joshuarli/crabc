...
supplementary-group and private statat path-metadata slices; none makes the
...
`times-reference`,
`fstat-reference`, `statat-reference`, `system-reference`, and
