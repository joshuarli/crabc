...
int main(void)
{
    ...
    char *dynamic_cwd;
    char *canonical;
    char link_name[] = "/tmp/crabc-m4-program-link-XXXXXX";
    char target_name[] = "/tmp/crabc-m4-program-target-XXXXXX";
    char ostemp[] = "/tmp/crabc-m4-program-XXXXXX";
    char stemps[] = "/tmp/crabc-m4-program-XXXXXX.suffix";
    char ostemps[] = "/tmp/crabc-m4-program-XXXXXX.tail";
    ...
    CHECK(setenv("CRABC_M4_SECURE_ENV", "visible", 1) == 0, "setenv");
    CHECK(secure_getenv("CRABC_M4_SECURE_ENV") != NULL &&
              strcmp(secure_getenv("CRABC_M4_SECURE_ENV"), "visible") == 0,
          "secure getenv");
