...
int main(void)
{
    char source_name[] = "/tmp/crabc-c-abi-io-source-XXXXXX";
    char range_name[] = "/tmp/crabc-c-abi-io-range-XXXXXX";
    char send_name[] = "/tmp/crabc-c-abi-io-send-XXXXXX";
    char splice_name[] = "/tmp/crabc-c-abi-io-splice-XXXXXX";
