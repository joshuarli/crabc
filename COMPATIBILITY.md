...
Generated: `2026-08-23T21:39:41+00:00`
...
| B | crabc static (controlled C) | built | 1066288 | 1665920 | 1567 | 0 | crabc archive selected |
...
Bounded native-facade O3/fat-LTO evidence: **FAIL**; report `compat/reports/lto/native-facade/latest.json`.
...
| --- | --- | --- | --- |
| control-o3 | unbuildable | n/a | no |
| fat-lto | unbuildable | n/a | no |
| stock-std-fat | unbuildable | n/a | no |
Claims: direct route=False; facade boundary eliminated=False; whole-program LTO=False; dynamic-libc LTO=False.

## libc-test

| subset | total | PASS | FAIL | BUILDERROR | TIMEOUT | SKIP |
| --- | --- | --- | --- | --- | --- | --- |
| all | 420 | 402 | 3 | 0 | 0 | 15 |
| api | 79 | 79 | 0 | 0 | 0 | 0 |
