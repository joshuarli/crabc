...
| `runtime-ticket-zero-test-v3.5.0.json` | Reviewed source map, seven-symbol inventory, one-shot caller contract, and native link contract for the process-lifetime ticket-zero C witness, including retained narrow and persistent mixed-local worker round trips. |
