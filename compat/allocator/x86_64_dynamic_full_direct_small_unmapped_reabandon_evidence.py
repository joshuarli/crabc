#!/usr/bin/env python3
"""Differentially prove one dynamic full direct-small unmapped exit route.

The native pinned-C fixture fills one arena-backed 1024-byte direct-small page
on a worker pthread while ``page_full_retain=2`` keeps that full small page in
its ordinary regular bin. No remote free is published. The worker runs real
``mi_thread_done`` and the joined consumer follows the direct-small partial
collector: nine frees retain ordinary unmapped abandonment, the tenth
publishes the dynamic mapped bitmap/count pair, and the remaining sequential
frees perform terminal PageMap and arena-slice release.

The direct-cache range is observed only while the worker Theap is live. The
fixture never dereferences that Theap or its direct cache after real
``mi_thread_done``. This is narrow private native Linux/x86-64 fixed-mimalloc
engine evidence; it does not claim public x86 support, general teardown,
general remote routing, or any AArch64 result.
"""
...
SCHEMA_PATH = ROOT / "compat/allocator/x86_64-dynamic-full-direct-small-unmapped-reabandon-evidence-v3.5.0.json"
REPORT_DEFAULT = ROOT / "compat/reports/allocator/x86_64/dynamic-full-direct-small-unmapped-reabandon.json"
RUST_TEST_SOURCE = ROOT / "crabc-mimalloc/src/dynamic_theap.rs"
EXPECTED_PROFILE = "linux-x86_64-private-dynamic-full-direct-small-unmapped-reabandon"
RUST_TEST_FILTER = (
    "dynamic_theap::tests::"
    "x86_64_dynamic_full_direct_small_unmapped_reabandon_trace_matches_pinned_c"
)
TRACE_BEGIN = "CRABC_MI_DYNAMIC_FULL_DIRECT_SMALL_UNMAPPED_EXIT_TRACE_BEGIN"
TRACE_END = "CRABC_MI_DYNAMIC_FULL_DIRECT_SMALL_UNMAPPED_EXIT_TRACE_END"
EXPECTED_SCOPE = {
    "aarch64_status_reused": False,
    "dynamic_full_direct_small_regular_bin_only": True,
    ...
    "no_remote_free_before_thread_done_only": True,
...
EXPECTED_TRACE_VALUES = {
    "trace.dynamic_full_direct_small_unmapped_exit.arena_backed": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.small_page": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.direct_small": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.full_before_thread_done": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.ordinary_regular_bin_before_thread_done": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.direct_cache_range_matches_before_thread_done": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.direct_cache_range_start": 113,
    "trace.dynamic_full_direct_small_unmapped_exit.direct_cache_range_end": 128,
    "trace.dynamic_full_direct_small_unmapped_exit.no_remote_free_before_thread_done": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.producer_thread_done_completed": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.producer_joined_before_consumer_frees": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.unmapped_after_thread_done": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.abandoned_after_thread_done": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.page_map_registered_after_thread_done": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.arena_page_bitmap_set_after_thread_done": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.ordinary_queue_detached_after_thread_done": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.dynamic_abandoned_bitmap_clear_after_thread_done": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.dynamic_abandoned_count_after_thread_done": 0,
    "trace.dynamic_full_direct_small_unmapped_exit.request_size": 1024,
    "trace.dynamic_full_direct_small_unmapped_exit.capacity": 64,
    "trace.dynamic_full_direct_small_unmapped_exit.reserved": 64,
    "trace.dynamic_full_direct_small_unmapped_exit.block_size": 1024,
    "trace.dynamic_full_direct_small_unmapped_exit.slice_count": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.used_after_thread_done": 64,
    "trace.dynamic_full_direct_small_unmapped_exit.used_after_first_consumer_free": 64,
    "trace.dynamic_full_direct_small_unmapped_exit.unmapped_prefix_free_count": 9,
    "trace.dynamic_full_direct_small_unmapped_exit.used_after_unmapped_prefix": 56,
    "trace.dynamic_full_direct_small_unmapped_exit.unmapped_after_unmapped_prefix": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.mapped_after_reabandon_boundary": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.dynamic_abandoned_bitmap_set_after_reabandon_boundary": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.dynamic_abandoned_count_after_reabandon_boundary": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.used_after_reabandon_boundary": 54,
    "trace.dynamic_full_direct_small_unmapped_exit.page_map_unregistered_after_final_free": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.arena_page_bitmap_clear_after_final_free": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.arena_slice_released_after_final_free": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.dynamic_abandoned_bitmap_clear_after_final_free": 1,
    "trace.dynamic_full_direct_small_unmapped_exit.dynamic_abandoned_count_after_final_free": 0,
    "trace.dynamic_full_direct_small_unmapped_exit.valid": 1,
}
...
#error this private dynamic full direct-small unmapped fixture requires native Linux/x86_64
#endif
...
#define CRABC_DYNAMIC_FULL_DIRECT_SMALL_UNMAPPED_MAX_BLOCKS 128
...
typedef struct fixture_s {
  ...
  mi_heap_t* heap;
  void* blocks[CRABC_DYNAMIC_FULL_DIRECT_SMALL_UNMAPPED_MAX_BLOCKS];
  size_t block_count;
  bool setup_valid;
  bool worker_ready;
  bool allow_thread_done;
  bool producer_done;
  bool ordinary_regular_bin_before_thread_done;
  bool direct_cache_range_matches_before_thread_done;
...
static void* producer_main(void* argument) {
  ...
  while (block_count < CRABC_DYNAMIC_FULL_DIRECT_SMALL_UNMAPPED_MAX_BLOCKS) {
  ...
  if (queue == NULL || block_count != (size_t)page->reserved
      ...
      || !regular || !direct_range || range_start != 113 || range_end != 128) {
    failure_stage = 6; goto failed;
  }
  fixture->heap = heap;
  fixture->block_count = block_count;
  fixture->ordinary_regular_bin_before_thread_done = regular;
  fixture->direct_cache_range_matches_before_thread_done = direct_range;
...
int main(void) {
  ...
  int stage = 0;
  int arena_backed = 0, small_page = 0, direct_small = 0, full_before_thread_done = 0;
  int ordinary_regular_bin_before_thread_done = 0;
  int direct_cache_range_matches_before_thread_done = 0;
  size_t direct_cache_range_start = 0, direct_cache_range_end = 0;
  int no_remote_free_before_thread_done = 0;
  int producer_thread_done_completed = 0, producer_joined_before_consumer_frees = 0;
  int unmapped_after_thread_done = 0, abandoned_after_thread_done = 0;
  ...
  int dynamic_abandoned_bitmap_clear_after_thread_done = 0;
  size_t dynamic_abandoned_count_after_thread_done = 0;
  size_t used_after_thread_done = 0, used_after_first_consumer_free = 0;
  size_t unmapped_prefix_free_count = 0;
  size_t used_after_unmapped_prefix = 0, used_after_reabandon_boundary = 0;
  int unmapped_after_unmapped_prefix = 0, mapped_after_reabandon_boundary = 0;
  int dynamic_abandoned_bitmap_set_after_reabandon_boundary = 0;
  size_t dynamic_abandoned_count_after_reabandon_boundary = 0;
  ...
  (void)pthread_mutex_unlock(&fixture.mutex);
  if (!setup_valid || fixture.heap == NULL || block_count < 12
      || block_count > CRABC_DYNAMIC_FULL_DIRECT_SMALL_UNMAPPED_MAX_BLOCKS
  ...
  /* Capture process-heap bookkeeping before the worker's real thread exit.
     The post-exit probe re-acquires only through a client block/PageMap and
     never inspects the departed Theap or its direct-cache image. */
  ...
  full_before_thread_done = mi_page_is_full(page) && page->used == page->reserved;
  ordinary_regular_bin_before_thread_done = fixture.ordinary_regular_bin_before_thread_done;
  direct_cache_range_matches_before_thread_done = fixture.direct_cache_range_matches_before_thread_done;
  direct_cache_range_start = fixture.direct_cache_range_start;
  direct_cache_range_end = fixture.direct_cache_range_end;
  no_remote_free_before_thread_done = mi_page_thread_free(page) == NULL;
  if (!arena_backed || !small_page || !direct_small || !full_before_thread_done
      ...
      || !no_remote_free_before_thread_done || capacity != block_count
      || reserved != block_count || slice_count == 0) goto output;
  stage = 4;
  if (pthread_mutex_lock(&fixture.mutex) != 0) goto output;
  ...
  page = _mi_safe_ptr_page(fixture.blocks[0]);
  if (page == NULL) goto output;
  saved_address = (uintptr_t)fixture.blocks[0];
  unmapped_after_thread_done = !mi_page_is_abandoned_mapped(page);
  ...
  dynamic_abandoned_bitmap_clear_after_thread_done = arena_pages->pages_abandoned[bin] == NULL
  ...
  used_after_thread_done = page->used;
  if (!unmapped_after_thread_done || !abandoned_after_thread_done
      ...
      || used_after_thread_done != capacity) goto output;
  stage = 6;
  /* The direct-small partial collector deliberately leaves one xthread head
     uncounted. It therefore keeps the first `reserved / 8 + 1` frees above
     the source mostly-used threshold. */
  unmapped_prefix_free_count = reserved / 8 + 1;
  if (unmapped_prefix_free_count + 1 >= block_count) goto output;
  mi_free(fixture.blocks[0]);
  fixture.blocks[0] = NULL;
  page = _mi_safe_ptr_page(fixture.blocks[1]);
  if (page == NULL) goto output;
  used_after_first_consumer_free = page->used;
  if (used_after_first_consumer_free != capacity) goto output;
  for (size_t index = 1; index < unmapped_prefix_free_count; index++) {
    mi_free(fixture.blocks[index]);
    fixture.blocks[index] = NULL;
  }
  page = _mi_safe_ptr_page(fixture.blocks[unmapped_prefix_free_count]);
  if (page == NULL) goto output;
  used_after_unmapped_prefix = page->used;
  unmapped_after_unmapped_prefix = !mi_page_is_abandoned_mapped(page)
      && mi_page_is_abandoned(page) && page->next == NULL && page->prev == NULL
      && !mi_page_is_owned(page)
      && mi_page_thread_free(page) != NULL
      && _mi_safe_ptr_page((const void*)saved_address) == page
      && mi_bitmap_is_setN(arena_pages->pages, slice_index, 1);
  if (!unmapped_after_unmapped_prefix
      || !(arena_pages->pages_abandoned[bin] == NULL
          || mi_bitmap_is_clearN(arena_pages->pages_abandoned[bin], slice_index, 1))
      || mi_atomic_load_relaxed(dynamic_abandoned_count) != 0
      || used_after_unmapped_prefix + unmapped_prefix_free_count != capacity + 1) goto output;
  stage = 7;
  mi_free(fixture.blocks[unmapped_prefix_free_count]);
  fixture.blocks[unmapped_prefix_free_count] = NULL;
  page = _mi_safe_ptr_page(fixture.blocks[unmapped_prefix_free_count + 1]);
  if (page == NULL) goto output;
  mapped_after_reabandon_boundary = mi_page_is_abandoned_mapped(page)
      && mi_page_is_abandoned(page) && page->next == NULL && page->prev == NULL
      && !mi_page_is_owned(page) && mi_page_thread_free(page) == NULL;
  dynamic_abandoned_bitmap_set_after_reabandon_boundary = arena_pages->pages_abandoned[bin] != NULL
      && mi_bitmap_is_setN(arena_pages->pages_abandoned[bin], slice_index, 1);
  dynamic_abandoned_count_after_reabandon_boundary = mi_atomic_load_relaxed(dynamic_abandoned_count);
  used_after_reabandon_boundary = page->used;
  /* The boundary first partly collects the preceding xthread entry, then
     reabandon-to-mapped unowns and fully collects the retained current head.
     Both entries are accounted before this post-boundary observation. */
  if (!mapped_after_reabandon_boundary || !dynamic_abandoned_bitmap_set_after_reabandon_boundary
      || dynamic_abandoned_count_after_reabandon_boundary != 1
      || used_after_reabandon_boundary + unmapped_prefix_free_count + 2 != capacity + 1) goto output;
  stage = 8;
  for (size_t index = unmapped_prefix_free_count + 1; index + 1 < block_count; index++) {
    mi_free(fixture.blocks[index]);
    fixture.blocks[index] = NULL;
  }
  ...
  valid = request_size == 1024 && capacity == 64 && reserved == 64 && block_size == 1024
      && slice_count == 1 && arena_backed && small_page && direct_small
      && full_before_thread_done && ordinary_regular_bin_before_thread_done
      && direct_cache_range_matches_before_thread_done
      && direct_cache_range_start == 113 && direct_cache_range_end == 128
      && no_remote_free_before_thread_done
      && producer_thread_done_completed && producer_joined_before_consumer_frees
      && unmapped_after_thread_done && abandoned_after_thread_done
      && page_map_registered_after_thread_done && arena_page_bitmap_set_after_thread_done
      && ordinary_queue_detached_after_thread_done
      && dynamic_abandoned_bitmap_clear_after_thread_done
      && dynamic_abandoned_count_after_thread_done == 0 && used_after_thread_done == 64
      && used_after_first_consumer_free == 64
      && unmapped_prefix_free_count == 9 && used_after_unmapped_prefix == 56
      && unmapped_after_unmapped_prefix && mapped_after_reabandon_boundary
  ...
  stage = 9;
output:
  printf("CRABC_MI_DYNAMIC_FULL_DIRECT_SMALL_UNMAPPED_EXIT_TRACE_BEGIN\n");
#define OUT_N(k, v) printf("trace.dynamic_full_direct_small_unmapped_exit.%s=%zu\n", k, (size_t)(v))
#define OUT_B(k, v) printf("trace.dynamic_full_direct_small_unmapped_exit.%s=%d\n", k, (v) ? 1 : 0)
  OUT_B("arena_backed", arena_backed);
  OUT_B("small_page", small_page);
  OUT_B("direct_small", direct_small);
  OUT_B("full_before_thread_done", full_before_thread_done);
  OUT_B("ordinary_regular_bin_before_thread_done", ordinary_regular_bin_before_thread_done);
  OUT_B("direct_cache_range_matches_before_thread_done", direct_cache_range_matches_before_thread_done);
  OUT_N("direct_cache_range_start", direct_cache_range_start);
  OUT_N("direct_cache_range_end", direct_cache_range_end);
  OUT_B("no_remote_free_before_thread_done", no_remote_free_before_thread_done);
  ...
  OUT_B("unmapped_after_thread_done", unmapped_after_thread_done);
  ...
  OUT_B("dynamic_abandoned_bitmap_clear_after_thread_done", dynamic_abandoned_bitmap_clear_after_thread_done);
  ...
  OUT_N("used_after_thread_done", used_after_thread_done);
  OUT_N("used_after_first_consumer_free", used_after_first_consumer_free);
  OUT_N("unmapped_prefix_free_count", unmapped_prefix_free_count);
  OUT_N("used_after_unmapped_prefix", used_after_unmapped_prefix);
  OUT_B("unmapped_after_unmapped_prefix", unmapped_after_unmapped_prefix);
  OUT_B("mapped_after_reabandon_boundary", mapped_after_reabandon_boundary);
  OUT_B("dynamic_abandoned_bitmap_set_after_reabandon_boundary", dynamic_abandoned_bitmap_set_after_reabandon_boundary);
  OUT_N("dynamic_abandoned_count_after_reabandon_boundary", dynamic_abandoned_count_after_reabandon_boundary);
  OUT_N("used_after_reabandon_boundary", used_after_reabandon_boundary);
  ...
  OUT_B("valid", valid);
  printf("CRABC_MI_DYNAMIC_FULL_DIRECT_SMALL_UNMAPPED_EXIT_TRACE_END\n");
  if (producer_started) {
  ...
  if (!valid) {
    fprintf(stderr,
        "dynamic full direct-small unmapped reabandon fixture stopped at stage %d (worker=%d)\n",
...
DYNAMIC_FULL_DIRECT_SMALL_UNMAPPED_EXIT_KIND = (
    "mimalloc-x86_64-dynamic-full-direct-small-unmapped-reabandon-differential-evidence"
)
...
def _schema_template() -> dict:
    ...
    value["schema"] = "crabc-mimalloc-x86_64-dynamic-full-direct-small-unmapped-reabandon-evidence"
...
def validate_c_command(command: list[str], schema: dict) -> None:
    ...
    if definitions != list(EXPECTED_COMPILE_DEFINITIONS) or definitions != list(
        ...
        raise EvidenceError("dynamic-full-direct-small-unmapped C command compile definitions drifted")
    if (
        ...
        raise EvidenceError(
            "dynamic-full-direct-small-unmapped C command release pthread/TLS selection drifted"
        )
...
def validate_normalized_c_command(command: object, schema: dict) -> None:
    ...
    if (
        ...
        raise EvidenceError("dynamic-full-direct-small-unmapped report C command drifted")
...
def build_c_trace(
    ...
    try:
        _base.run.require_success(
            ...
            "pinned C dynamic-full-direct-small-unmapped fixture build",
        )
        header = _base.run.command_record((readelf, "-h", str(probe_binary)), cwd=source)
        _base.run.require_success(
            header, "pinned C dynamic-full-direct-small-unmapped fixture ELF identity"
        )
        elf = _base.run.parse_elf_identity(str(header["stdout"]), "x86_64")
        execution = _base.run.command_record((str(probe_binary),), cwd=source)
        _base.run.require_success(
            execution, "pinned C dynamic-full-direct-small-unmapped fixture execution"
        )
    except _base.run.HarnessError as error:
        raise EvidenceError(str(error)) from error
    trace = parse_trace(
        str(execution["stdout"]),
        description="pinned C dynamic-full-direct-small-unmapped trace",
    )
    validate_trace(trace, description="pinned C dynamic-full-direct-small-unmapped trace")
    return {
...
def report_from_results(**kwargs):
    ...
    report["kind"] = DYNAMIC_FULL_DIRECT_SMALL_UNMAPPED_EXIT_KIND
    validate_report(report)
    return report


def validate_report(report: dict) -> None:
    if report.get("kind") != DYNAMIC_FULL_DIRECT_SMALL_UNMAPPED_EXIT_KIND:
        raise EvidenceError("dynamic-full-direct-small-unmapped report kind drifted")
    ...
    if c_probe.get("source_sha256") != sha256_bytes(C_TRACE_PROBE.encode("utf-8")):
        raise EvidenceError("dynamic-full-direct-small-unmapped report C source hash drifted")
...
def main() -> int:
    ...
    try:
        ...
        print(
            "allocator x86-64 dynamic-full-direct-small-unmapped differential: FAIL: "
            f"{error}",
            file=os.sys.stderr,
        )
        return 1
    print(
        "allocator x86-64 dynamic-full-direct-small-unmapped differential: PASS "
