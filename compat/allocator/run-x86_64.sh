...
Private native Linux/x86-64 mimalloc evidence commands:
  ...
  allocator-m1
  allocator-m2
  allocator-tls | allocator-lifecycle [--only runtime-process-policy-first-arena] | allocator-startup-regular-arena [--reader-tests] | allocator-init-recursion | allocator-fault
