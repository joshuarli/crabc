/* Pinned-musl/project Linux/x86-64 timer_getoverrun declaration gate. */
...
int crabc_x86_64_timer_getoverrun_header_abi_hidden_probe(void)
{
    return timer_getoverrun((timer_t)0);
}
#else
...
int crabc_x86_64_timer_getoverrun_header_abi_probe(void)
{
    return timer_getoverrun_function != (timer_getoverrun_signature)0 ? 0 : 1;
}
#endif
