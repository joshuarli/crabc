/* Native Linux/x86-64 C++ declaration/linkage contract for tanh/tanhf. */
...
static double_unary volatile direct_tanh = &(tanh);
static float_unary volatile direct_tanhf = &(tanhf);
...
extern "C" int crabc_x86_64_math_tanh_header_probe(void)
{
	return direct_tanh == nullptr || direct_tanhf == nullptr;
}
