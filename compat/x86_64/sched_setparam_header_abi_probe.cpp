/* C++ companion for the Linux/x86-64 sched_setparam ABI probe. */
...
using sched_setparam_signature = int (*)(pid_t, const struct sched_param *);

static_assert(__is_same(decltype(&sched_setparam),
...
{
    static volatile sched_setparam_signature witness = &sched_setparam;
    (void)witness;
}
