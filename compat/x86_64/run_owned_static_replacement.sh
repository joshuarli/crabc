...
readonly roles=(MALLOC_TRIO MALLOC_FULL STRINGS PRINTF VSNPRINTF SCANF MATH WIDE SYSTEM FILES NETWORK ACCOUNTS THREADS STDIO_BLOCK FPUTS FFLUSH GETDELIM SETVBUF WIDE_STREAM FCLOSE BYTE)
