/* C++17 linkage probe for the sealed suppressed-scanset scanf artifact.
 *
 ...
 * This is not a general scanset, runtime, or stdio evidence claim.
 */
...
#if !defined(CRABC_STDIO_FIXED_SUPPRESSED_SCANSET_SCAN_HEADER_CXX17)
#error "the C++17 suppressed-scanset scanf header profile must be selected"
#endif
...
int crabc_x86_64_stdio_fixed_suppressed_scanset_scan_header_abi_probe_cpp()
{
    return 0;
}
