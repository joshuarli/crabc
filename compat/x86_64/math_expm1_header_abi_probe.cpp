/* Native Linux/x86-64 C++ declaration/linkage contract for expm1/expm1f. */
...
static double_unary volatile direct_expm1 = &(expm1);
static float_unary volatile direct_expm1f = &(expm1f);
...
extern "C" int crabc_x86_64_math_expm1_header_probe(void)
{
	return direct_expm1 == nullptr || direct_expm1f == nullptr;
}
