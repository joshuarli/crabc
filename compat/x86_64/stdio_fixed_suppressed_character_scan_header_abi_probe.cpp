/* C++17 linkage probe for the sealed suppressed-character scanf artifact.
 *
 ...
 * This is not runtime, conversion completion, or general stdio evidence.
 */
...
#if !defined(CRABC_STDIO_FIXED_SUPPRESSED_CHARACTER_SCAN_HEADER_CXX17)
#error "the C++17 suppressed-character scanf header profile must be selected"
#endif
...
int crabc_x86_64_stdio_fixed_suppressed_character_scan_header_abi_probe_cpp()
{
    return 0;
}
