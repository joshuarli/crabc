/* Native Linux/x86-64 C++ declaration/linkage contract for tan/tanf. */
...
static double_unary volatile direct_tan = &(tan);
static float_unary volatile direct_tanf = &(tanf);
...
extern "C" int crabc_x86_64_math_tan_header_probe(void)
{
	return direct_tan == nullptr || direct_tanf == nullptr;
}
