...
class OwnedDynamicQualificationTests(unittest.TestCase):
    ...
    def test_each_product_requires_runtime_regressions(self):
        for product in qualification.PRODUCTS:
            for case in ("mimalloc-startup-errno", "stdio-allocator-interposition", "c-allocation-interposition", "pthread-cpuclock", "signal-handler-fork", "wide-calendar", "regex", "monetary", "fmtmsg", "underscore-fork", "utmpx", "account-files", "locale"):
