...
class X86ParityLedgerTests(unittest.TestCase):
    ...
    def test_checked_in_ledger_is_closed_and_not_a_public_support_claim(self) -> None:
        ...
        self.assertEqual(report["verified_artifact_count"], 162)
    ...
    def test_ns_get16_artifact_keeps_its_private_codec_boundary(self) -> None:
        ...
        for phrase in (
            ...
            "ns_get32, ns_put16, and ns_put32 are separately selected artifacts",
        ):
            self.assertIn(phrase, source_mapping)
    ...
    def test_ns_get32_artifact_keeps_its_private_codec_boundary(self) -> None:
        ...
        for phrase in (
            ...
            "no relocation, call, or syscall",
            "ns_get16, ns_put16, and ns_put32 are separately selected artifacts",
        ):
            self.assertIn(phrase, source_mapping)
    ...
    def test_ns_put16_artifact_keeps_its_private_codec_boundary(self) -> None:
        ...
        for phrase in (
            ...
            "no relocation, call, or syscall",
            "ns_get16, ns_get32, and ns_put32 are separately selected artifacts",
        ):
            self.assertIn(phrase, source_mapping)
