...
class X86ParityLedgerTests(unittest.TestCase):
    ...
    def test_posix_spawnattr_destroy_artifact_stays_private_and_non_promoting(
        self,
    ) -> None:
        data = self.data()
        family = self.family(data, "libc.c-abi-compat")
        ...
        artifact = next(
            ...
            for entry in artifacts
            if isinstance(entry, dict)
            and entry["id"] == "static-c-posix-spawnattr-destroy"
        )
        self.assertNotIn("capabilities", artifact)
        for phrase in (
            "POSIX spawn-attribute destruction compatibility no-op artifact",
            "`int posix_spawnattr_destroy(posix_spawnattr_t *)`",
            "`src/process/posix_spawnattr_destroy.c::posix_spawnattr_destroy`",
            "exactly `return 0;`",
            "byte-filled caller-owned attribute object",
            "null pointer",
            "without changing the caller bytes",
            "`posix_spawn`",
            "`posix_spawnp`",
        ...
        assert isinstance(owners, list)
        for owner in (
            "libc/src/c_abi/x86_64/posix_spawnattr_destroy.rs",
            "include/spawn.h",
            "include/features.h",
            "include/bits/alltypes.h",
            "compat/x86_64/posix_spawnattr_destroy_header_abi_probe.c",
            "compat/x86_64/posix_spawnattr_destroy_header_abi_probe.cpp",
            "compat/x86_64/run_posix_spawnattr_destroy_header_abi.sh",
            "compat/x86_64/libc_posix_spawnattr_destroy_probe.c",
            "compat/x86_64/libc_posix_spawnattr_destroy_start.S",
            "compat/x86_64/run_libc_posix_spawnattr_destroy.sh",
            "compat/x86_64/static_c_abi_exports.txt",
        ):
            self.assertIn(owner, owners)
        ...
        self.assertTrue(
            any(
                "SysV AMD64" in item
                and "int posix_spawnattr_destroy(posix_spawnattr_t *)" in item
                and "rdi" in item
                and "eax" in item
                and "does not read, write, free, retain" in item
                for item in prerequisites
            )
        )
        self.assertTrue(
        ...
        self.assertEqual(
            evidence[0]["command"],
            "./scripts/dev-x86_64.sh libc-posix-spawnattr-destroy",
        )
        for phrase in (
            "Pinned-musl/project C/C++ header",
            "true dependency-free x86 crabc-libc `-nostdlib -static` candidate",
            "direct and function-pointer fixed zero returns",
            "byte-filled caller-owned posix_spawnattr_t object",
            "unchanged caller bytes",
            "stale errno preservation",
            "posix_spawnattr_destroy.lo/AArch64 ownership",
        ...
        prerequisites[1] = prerequisites[1].replace(
            "return 0;", "launch a child"
        )
        with self.assertRaisesRegex(
            ledger.LedgerError,
            "static-c-posix-spawnattr-destroy must retain its pinned-musl source mapping",
        ):
            ledger.validate_ledger(data)
    ...
    def test_posix_spawnattr_setpgroup_artifact_stays_private_and_non_promoting(
        self,
    ) -> None:
        data = self.data()
        family = self.family(data, "libc.c-abi-compat")
        ...
        artifact = next(
            ...
            for entry in artifacts
            if isinstance(entry, dict)
            and entry["id"] == "static-c-posix-spawnattr-setpgroup"
        )
        self.assertNotIn("capabilities", artifact)
        for phrase in (
            "POSIX spawn-attribute process-group assignment C ABI artifact",
            "`int posix_spawnattr_setpgroup(posix_spawnattr_t *, pid_t)`",
            "`src/process/posix_spawnattr_setpgroup.c::posix_spawnattr_setpgroup`",
            "exactly `attr->__pgrp = pgrp; return 0;`",
            "zero, negative, and positive `pid_t` values",
            "offset-four field",
            "every other byte",
            "valid non-null caller-owned attribute record",
            "`posix_spawn`",
            "`posix_spawnp`",
            "`posix_spawnattr_init`",
        ...
        assert isinstance(owners, list)
        for owner in (
            "libc/src/c_abi/x86_64/posix_spawnattr_setpgroup.rs",
            "include/spawn.h",
            "include/features.h",
            "include/bits/alltypes.h",
            "compat/x86_64/posix_spawnattr_setpgroup_header_abi_probe.c",
            "compat/x86_64/posix_spawnattr_setpgroup_header_abi_probe.cpp",
            "compat/x86_64/run_posix_spawnattr_setpgroup_header_abi.sh",
            "compat/x86_64/libc_posix_spawnattr_setpgroup_probe.c",
            "compat/x86_64/libc_posix_spawnattr_setpgroup_start.S",
            "compat/x86_64/run_libc_posix_spawnattr_setpgroup.sh",
            "compat/x86_64/static_c_abi_exports.txt",
        ):
            self.assertIn(owner, owners)
        ...
        self.assertTrue(
            any(
                "SysV AMD64" in item
                and "int posix_spawnattr_setpgroup(posix_spawnattr_t *, pid_t)"
                in item
                and "rdi" in item
                and "esi" in item
                and "eax" in item
        ...
        self.assertTrue(
            any(
                "src/process/posix_spawnattr_setpgroup.c::posix_spawnattr_setpgroup"
                in item
                and "attr->__pgrp = pgrp; return 0;" in item
                and "process-group readback" in item
        ...
        self.assertEqual(
            evidence[0]["command"],
            "./scripts/dev-x86_64.sh libc-posix-spawnattr-setpgroup",
        )
        for phrase in (
            "Pinned-musl/project C/C++ header",
            "true dependency-free x86 crabc-libc `-nostdlib -static --gc-sections` candidate",
            "direct and function-pointer fixed zero returns",
            "zero/negative/positive pid_t values",
            "byte-filled caller-owned posix_spawnattr_t record",
            "offset-four __pgrp int changed",
            "every other byte unchanged",
            "stale errno preservation",
            "posix_spawnattr_setpgroup.lo/AArch64 ownership",
            "peer spawn extraction",
            "public x86 support",
        ):
            self.assertIn(phrase, evidence[0]["scope"])
        ...
        prerequisites[1] = prerequisites[1].replace(
            "attr->__pgrp = pgrp; return 0;", "launch a child"
        )
        with self.assertRaisesRegex(
            ledger.LedgerError,
            "static-c-posix-spawnattr-setpgroup must retain its pinned-musl source mapping",
        ):
            ledger.validate_ledger(data)

    def test_posix_spawnattr_setschedpolicy_artifact_stays_private_and_non_promoting(
        self,
    ) -> None:
        data = self.data()
        family = self.family(data, "libc.c-abi-compat")
        ...
        artifact = next(
            ...
            for entry in artifacts
            if isinstance(entry, dict)
            and entry["id"] == "static-c-posix-spawnattr-setschedpolicy"
        )
        self.assertNotIn("capabilities", artifact)
        for phrase in (
            "POSIX spawn-attribute scheduler-policy compatibility C ABI artifact",
            "`int posix_spawnattr_setschedpolicy(posix_spawnattr_t *, int)`",
            "`src/process/posix_spawnattr_sched.c::posix_spawnattr_setschedpolicy`",
            "exactly `return ENOSYS;`",
            "byte-filled caller-owned attribute record",
            "null pointer",
            "stale errno preservation",
            "does not read, write, retain, or require a non-null attribute pointer",
            "`posix_spawn`",
            "`posix_spawnp`",
            "`posix_spawnattr_init`",
            "scheduler-policy readback",
            "file actions",
            "public x86 support",
        ):
            self.assertIn(phrase, artifact["description"])
        ...
        assert isinstance(owners, list)
        for owner in (
            "libc/src/c_abi/x86_64/posix_spawnattr_setschedpolicy.rs",
            "include/spawn.h",
            "include/errno.h",
            "compat/abi/musl-1.2.6/aarch64/libc.a.static.tsv",
            "compat/x86_64/posix_spawnattr_setschedpolicy_header_abi_probe.c",
            "compat/x86_64/posix_spawnattr_setschedpolicy_header_abi_probe.cpp",
            "compat/x86_64/run_posix_spawnattr_setschedpolicy_header_abi.sh",
            "compat/x86_64/libc_posix_spawnattr_setschedpolicy_probe.c",
            "compat/x86_64/libc_posix_spawnattr_setschedpolicy_start.S",
            "compat/x86_64/run_libc_posix_spawnattr_setschedpolicy.sh",
            "compat/x86_64/static_c_abi_exports.txt",
        ):
            self.assertIn(owner, owners)
        ...
        self.assertTrue(
            any(
                "SysV AMD64" in item
                and "int posix_spawnattr_setschedpolicy(posix_spawnattr_t *, int)"
                in item
                and "rdi" in item
                and "esi" in item
                and "eax" in item
                and "does not read, write, retain, or require a non-null" in item
                for item in prerequisites
            )
        )
        self.assertTrue(
            any(
                ...
                and "scheduler-policy readback" in item
                and "child lifecycle" in item
                for item in prerequisites
            )
        )
        ...
        self.assertEqual(
            evidence[0]["command"],
            "./scripts/dev-x86_64.sh libc-posix-spawnattr-setschedpolicy",
        )
        for phrase in (
            "Pinned-musl/project C/C++ header",
            "true dependency-free x86 crabc-libc `-nostdlib -static --gc-sections` candidate",
            "direct and function-pointer fixed ENOSYS returns",
            "byte-filled caller-owned posix_spawnattr_t record and a null pointer",
            "byte-filled caller-owned storage unchanged",
            "stale errno preservation",
        ...
        with self.assertRaisesRegex(
            ledger.LedgerError,
            "static-c-posix-spawnattr-setschedpolicy must retain its pinned-musl source mapping",
        ):
            ledger.validate_ledger(data)
