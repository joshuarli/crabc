    ...
    def test_mount_authority_is_confined_to_dynamic_product_and_pty_gates(self):
        ...
        with tempfile.TemporaryDirectory(dir=scratch) as temporary:
            ...
            for command, needs_mount in (
                ...
                ("owned-crypt-runtime", False),
                ("owned-atomic-addressable-profile", False),
                ...
                ("owned-underscore-fork", False),
                ("owned-process-control", False),
                ("owned-filesystem-mechanisms", True),
                ("owned-error-reporting", False),
                ("owned-stdio-allocator-interposition", False),
                ("owned-mimalloc-startup-errno", False),
                ("owned-signal-handler-fork", False),
                ("owned-passwd", False),
                ("owned-posix-filesystem", False),
                ("owned-nftw-relative-base", False),
                ...
                ("owned-strfmon", False),
                ("owned-fmtmsg", False),
                ("owned-c-abi-compat", False),
                ("owned-utmpx", False),
                ("owned-account-files", False),
                ("owned-rand", False),
                ("owned-regex", False),
            ):
