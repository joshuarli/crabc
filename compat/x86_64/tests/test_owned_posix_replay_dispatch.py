...
COMMANDS = (
    ...
    "owned-process-trio", "owned-underscore-fork", "owned-native-allocator-fork", "owned-native-worker-lifecycle", "owned-native-allocator-stress", "owned-allocator-override", "owned-native-allocator-policy", "owned-utmpx", "owned-account-files", "owned-syslog", "owned-crypt-runtime", "owned-system-cancellation",
    "owned-signal-helpers", "owned-pthread-signal", "owned-posix-timers", "owned-regex",
...
class OwnedPosixReplayDispatchTests(unittest.TestCase):
    ...
    def test_help_describes_exact_replay_interfaces(self):
        ...
        for command in COMMANDS:
            suffix = "DYNAMIC_SYSROOT" if command in DYNAMIC_REQUIRED else "[DYNAMIC_SYSROOT]"
