...
COMMANDS = (
    ...
    "owned-process-trio", "owned-underscore-fork", "owned-native-allocator-fork", "owned-native-worker-lifecycle", "owned-utmpx", "owned-account-files", "owned-syslog", "owned-crypt-runtime", "owned-system-cancellation",
