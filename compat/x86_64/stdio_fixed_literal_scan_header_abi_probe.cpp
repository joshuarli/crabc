/* C++17 linkage probe for the sealed raw-literal scanf artifact.
 *
...
#if !defined(CRABC_STDIO_FIXED_LITERAL_SCAN_HEADER_CXX17)
#error "the C++17 raw-literal scanf header profile must be selected"
#endif
...
int crabc_x86_64_stdio_fixed_literal_scan_header_abi_probe_cpp()
{
    return 0;
}
