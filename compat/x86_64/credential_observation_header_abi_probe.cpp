/* C++ companion for the Linux/x86-64 <unistd.h> credential-observation probe. */
...
using getgroups_signature = int (*)(int, gid_t *);

static_assert(__is_same(decltype(&getgroups), getgroups_signature),
...
using getresuid_signature = int (*)(uid_t *, uid_t *, uid_t *);
using getresgid_signature = int (*)(gid_t *, gid_t *, gid_t *);

static_assert(__is_same(decltype(&getresuid), getresuid_signature),
    "getresuid declaration");
static_assert(__is_same(decltype(&getresgid), getresgid_signature),
    "getresgid declaration");
...
using hidden_getresuid_signature = int (*)(uid_t *, uid_t *, uid_t *);
using hidden_getresgid_signature = int (*)(gid_t *, gid_t *, gid_t *);
...
int crabc_x86_64_credential_observation_header_abi_probe_cpp()
{
    gid_t groups[1];
