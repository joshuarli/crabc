...
Its current 596 comparable red source-form rows, one
...
Its 2,539 same-identity source-form
differences across 425 rows—including 78 form-only rows—remain separately
