...
Its current 718 comparable red source-form rows, one
...
macro visibility across all 1,337 rows: 619 current identity-mismatch rows,
661 matched rows, while the one `aio.h:c11-strict` oracle-not-applicable row
