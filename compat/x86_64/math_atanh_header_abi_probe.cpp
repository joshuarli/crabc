/* Native Linux/x86-64 C++ declaration/linkage contract for atanh/atanhf. */
...
static double_unary volatile direct_atanh = &(atanh);
static float_unary volatile direct_atanhf = &(atanhf);
...
extern "C" int crabc_x86_64_math_atanh_header_probe(void)
{
	return direct_atanh == nullptr || direct_atanhf == nullptr;
}
