...
readonly C_PROBE="$ROOT_DIR/compat/x86_64/l64a_header_abi_probe.c"
    ...
    for language in c cxx; do
        for variant in oracle project; do
            ...
            if [ "$language" = c ]; then
                ...
                object="$work_dir/${variant}-${definition#-D}-l64a.o"
...
while IFS= read -r path; do
    case "$path" in
        ...
        *) fail "project X/Open header trace escaped its declared roots: $path" ;;
    esac
