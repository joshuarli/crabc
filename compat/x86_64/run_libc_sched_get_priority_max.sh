...
# SCHED_FIFO, SCHED_RR, and a rejected invalid policy. It does not select the
# source sibling sched_get_priority_min, policy mutation/parameters, affinity,
# scheduling guarantees, C11/pthread lifecycle, process lifecycle, CRT,
