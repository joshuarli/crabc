/* Native Linux/x86-64 C++ declaration/linkage contract for sin/sinf. */
...
static double_unary volatile direct_sin = &(sin);
static float_unary volatile direct_sinf = &(sinf);
...
extern "C" int crabc_x86_64_math_sin_header_probe(void)
{
	return direct_sin == nullptr || direct_sinf == nullptr;
}
