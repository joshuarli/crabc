...
for unselected in mbsnrtowcs wcsnrtombs wcstod_l strftime_l wcsftime_l \
    fwide fgetwc fputwc \
...
# The fixed-locale narrow `_l` wrappers are a separately evidenced aggregate
# sibling that composes with these tokens and TLS state.
