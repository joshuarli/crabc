/* Native Linux/x86-64 C++ declaration/linkage contract for acosh/acoshf. */
...
static double_unary volatile direct_acosh = &(acosh);
static float_unary volatile direct_acoshf = &(acoshf);
...
extern "C" int crabc_x86_64_math_acosh_header_probe(void)
{
	return direct_acosh == nullptr || direct_acoshf == nullptr;
}
