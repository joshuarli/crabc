/* Native Linux/x86-64 C++ declaration/linkage contract for exp10/pow10. */
...
static double_unary volatile direct_exp10 = &(exp10);
static double_unary volatile direct_pow10 = &(pow10);
...
extern "C" int crabc_x86_64_math_exp10_header_probe(void)
{
	return direct_exp10 == nullptr || direct_pow10 == nullptr ||
		direct_exp10 != direct_pow10;
}
