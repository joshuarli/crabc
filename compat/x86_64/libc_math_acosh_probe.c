...
#define ACOSH_F64_CASES 32
#define ACOSH_F32_CASES 32
#define ACOSH_ROUNDING_CASES 4
#define ACOSH_RECORD_WORDS 4
...
static const uint64_t binary64_inputs[ACOSH_F64_CASES] = {
...
static const uint32_t binary32_inputs[ACOSH_F32_CASES] = {
