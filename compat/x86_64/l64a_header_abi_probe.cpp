/* C++17 companion for the Linux/x86-64 a64l/l64a declaration gate. */
...
using a64l_signature = long (*)(const char *);
...
static_assert(__is_same(decltype(&a64l), a64l_signature),
              "C++ a64l declaration");
...
int crabc_x86_64_l64a_header_abi_probe_cpp()
{
    ...
    return a64l_function != nullptr ? 0 : 1;
#else
    return 0;
#endif
}
