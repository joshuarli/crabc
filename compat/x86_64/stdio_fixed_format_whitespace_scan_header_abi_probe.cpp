/* C++17 linkage probe for the sealed format-whitespace scanf artifact.
 *
...
#if !defined(CRABC_STDIO_FIXED_FORMAT_WHITESPACE_SCAN_HEADER_CXX17)
#error "the C++17 format-whitespace scanf header profile must be selected"
#endif
...
int crabc_x86_64_stdio_fixed_format_whitespace_scan_header_abi_probe_cpp()
{
    return 0;
}
