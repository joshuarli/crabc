/* C++17 linkage probe for the sealed empty-format scanf artifact.
 *
 ...
 * This is not runtime, conversion, or general stdio evidence.
 */
...
#if !defined(CRABC_STDIO_FIXED_EMPTY_FORMAT_SCAN_HEADER_CXX17)
#error "the C++17 empty-format scanf header profile must be selected"
#endif
...
int crabc_x86_64_stdio_fixed_empty_format_scan_header_abi_probe_cpp()
{
    return 0;
}
