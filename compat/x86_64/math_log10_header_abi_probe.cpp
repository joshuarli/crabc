/* Native Linux/x86-64 C++ declaration/linkage contract for log10/log10f. */
...
static double_unary volatile direct_log10 = &(log10);
static float_unary volatile direct_log10f = &(log10f);
...
extern "C" int crabc_x86_64_math_log10_header_probe(void)
{
	return direct_log10 == nullptr || direct_log10f == nullptr;
}
