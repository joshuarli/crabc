/* C++17 linkage probe for the sealed suppressed-string scanf artifact.
 *
...
#if !defined(CRABC_STDIO_FIXED_SUPPRESSED_STRING_SCAN_HEADER_CXX17)
#error "the C++17 suppressed-string scanf header profile must be selected"
#endif
...
int crabc_x86_64_stdio_fixed_suppressed_string_scan_header_abi_probe_cpp()
{
    return 0;
}
