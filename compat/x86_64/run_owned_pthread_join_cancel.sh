...
printf 'owned pthread_join cancellation: PASS (musl + requested installed entries, entry/blocked cancellation, disabled/masked states, cleanup and target reclamation); evidence: %s\n' "$work"
