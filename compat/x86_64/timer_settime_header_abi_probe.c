/* Pinned-musl/project Linux/x86-64 timer_settime declaration gate. */
...
int crabc_x86_64_timer_settime_header_abi_hidden_probe(void)
{
    return timer_settime((timer_t)0, 0, (const struct itimerspec *)0,
        (struct itimerspec *)0);
}
#else
...
int crabc_x86_64_timer_settime_header_abi_probe(void)
{
    return timer_settime_function != (timer_settime_signature)0 ? 0 : 1;
}
#endif
