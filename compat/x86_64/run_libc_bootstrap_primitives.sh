...
for header in errno.h fenv.h setjmp.h bits/setjmp.h signal.h string.h strings.h sys/mman.h \
...
for unselected in syscall malloc free calloc realloc pthread_create \
