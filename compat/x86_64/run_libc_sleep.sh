...
for unselected in usleep clock_settime clock_getcpuclockid timer_create \
    timer_delete timer_getoverrun timer_gettime timer_settime setitimer alarm \
    ualarm malloc free calloc realloc; do
