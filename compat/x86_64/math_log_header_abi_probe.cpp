/* Native Linux/x86-64 C++ declaration/linkage contract for log/logf. */
...
static double_unary volatile direct_log = &(log);
static float_unary volatile direct_logf = &(logf);
...
extern "C" int crabc_x86_64_math_log_header_probe(void)
{
	return direct_log == nullptr || direct_logf == nullptr;
}
