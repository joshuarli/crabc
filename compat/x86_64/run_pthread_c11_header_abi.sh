...
assert_cxx_c_linkage() {
    ...
    local -a required_symbols=(
        ...
        pthread_mutexattr_init pthread_mutexattr_destroy pthread_mutexattr_gettype pthread_mutexattr_settype pthread_mutexattr_getprotocol pthread_mutexattr_getpshared pthread_mutexattr_getrobust
        pthread_cond_init pthread_cond_destroy pthread_cond_wait pthread_condattr_init pthread_condattr_destroy
