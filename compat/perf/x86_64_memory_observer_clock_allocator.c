/* Separate memory-only artifact for the supplemental clock/allocator fixture. */
#ifndef _GNU_SOURCE
#define _GNU_SOURCE
#endif
...
#define main crabc_perf_supplemental_original_clock_allocator_main
#define crabc_perf_observer_reach crabc_perf_supplemental_memory_reach
#include "x86_64_clock_allocator_workload.c"
...
main(int argc, char **argv)
{
    ...
    return crabc_perf_supplemental_memory_finish(
        crabc_perf_supplemental_original_clock_allocator_main(argc, argv));
}
