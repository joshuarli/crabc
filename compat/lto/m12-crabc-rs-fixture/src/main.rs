//! Bounded M12 application workload for native `crabc-rs` LTO inspection.
//!
...
const OK: &[u8] = b"m12-crabc-rs:ok\n";
const FAIL_PID: &[u8] = b"m12-crabc-rs:fail:pid\n";
const FAIL_FILE: &[u8] = b"m12-crabc-rs:fail:file\n";
const FAIL_PIPE: &[u8] = b"m12-crabc-rs:fail:pipe\n";
const FAIL_EVENT: &[u8] = b"m12-crabc-rs:fail:eventfd\n";
...
///
/// This exported route is the M12 ELF inspection anchor. It consumes the
...
#[inline(never)]
#[no_mangle]
pub extern "C" fn m12_direct_route() -> i32 {
