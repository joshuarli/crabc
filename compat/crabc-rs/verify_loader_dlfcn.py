#!/usr/bin/env python3
"""Verify the bounded loader probe's private-runtime boundary."""
...
def fixture_archive(target_dir: Path) -> Path:
    archive = target_dir / "release" / "examples" / "libloader_dlfcn_basic_probe.a"
    require(archive.is_file(), f"loader probe archive does not exist: {archive}")
    return archive
