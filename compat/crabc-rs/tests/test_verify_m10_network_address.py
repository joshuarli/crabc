"""Focused semantic-proof tests for the M10 network-byte-order verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_m10_network_address", ROOT / "compat" / "crabc-rs" / "verify_m10_network_address.py"
)
...
class VerifyM10NetworkAddressTests(unittest.TestCase):
