...
SCRIPT = ROOT / "compat/crabc-rs/verify_m5.py"
SPEC = importlib.util.spec_from_file_location("verify_m5", SCRIPT)
...
class InspectionTests(unittest.TestCase):
    def test_accepts_required_m5_direct_aarch64_syscalls(self) -> None:
    ...
    def test_rejects_public_abi_or_missing_m5_syscall(self) -> None:
