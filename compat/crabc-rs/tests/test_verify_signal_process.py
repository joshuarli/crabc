"""Focused parser tests for the direct-boundary verifier."""
...
SPEC = importlib.util.spec_from_file_location("verify_signal_process", ROOT / "compat" / "crabc-rs" / "verify_signal_process.py")
...
class VerifySignalProcessTests(unittest.TestCase):
