"""Focused semantic-proof tests for the M8 native-fnmatch verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_m8_fnmatch", ROOT / "compat" / "crabc-rs" / "verify_m8_fnmatch.py"
)
...
class VerifyM8FnmatchTests(unittest.TestCase):
    def test_accepts_aarch64_native_entrypoint_without_undefined_symbols(self) -> None:
        report = VERIFY.inspect(
            "Machine: AArch64",
            "",
            "0000000000000000 T crabc_rs_m8_fnmatch_direct_probe\n",
        )
