"""Focused parser tests for the M7 private-loader verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_m7_loader", ROOT / "compat" / "crabc-rs" / "verify_m7_loader.py"
)
...
class VerifyM7LoaderTests(unittest.TestCase):
