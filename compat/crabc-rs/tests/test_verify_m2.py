...
SCRIPT = ROOT / "compat/crabc-rs/verify_m2.py"
SPEC = importlib.util.spec_from_file_location("verify_m2", SCRIPT)
...
class InspectionTests(unittest.TestCase):
    ...
    def test_rejects_public_abi_errno_or_missing_m2_syscall(self) -> None:
