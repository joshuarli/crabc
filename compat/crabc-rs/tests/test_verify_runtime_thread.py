"""Focused parser tests for the private-thread verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_runtime_thread",
    ROOT / "compat" / "crabc-rs" / "verify_runtime_thread.py",
)
...
class VerifyRuntimeThreadTests(unittest.TestCase):
