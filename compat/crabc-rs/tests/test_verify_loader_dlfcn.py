"""Focused parser tests for the private-loader verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_loader_dlfcn", ROOT / "compat" / "crabc-rs" / "verify_loader_dlfcn.py"
)
...
class Verify1LoaderTests(unittest.TestCase):
