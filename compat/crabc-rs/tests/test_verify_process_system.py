...
SCRIPT = ROOT / "compat/crabc-rs/verify_process_system.py"
SPEC = importlib.util.spec_from_file_location("verify_process_system", SCRIPT)
...
class InspectionTests(unittest.TestCase):
    def test_accepts_required_process_system_direct_aarch64_syscalls(self) -> None:
    ...
    def test_rejects_public_abi_or_missing_process_system_syscall(self) -> None:
