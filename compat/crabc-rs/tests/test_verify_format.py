"""Focused semantic-proof tests for the bounded-formatting verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_format", ROOT / "compat" / "crabc-rs" / "verify_format.py"
)
