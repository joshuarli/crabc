"""Focused parser tests for the M11 private-loader verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_m11_loader", ROOT / "compat" / "crabc-rs" / "verify_m11_loader.py"
)
...
class VerifyM11LoaderTests(unittest.TestCase):
    ...
    def test_rejects_public_dlfcn_or_errno_symbols(self) -> None:
        ...
        with self.assertRaisesRegex(VERIFY.VerificationError, "private"):
            VERIFY.inspect("Machine: AArch64", "                 U dlsym\n")
