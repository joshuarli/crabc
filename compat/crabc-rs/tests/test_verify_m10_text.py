"""Focused semantic-proof tests for the M10 native-text verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_m10_text", ROOT / "compat" / "crabc-rs" / "verify_m10_text.py"
)
