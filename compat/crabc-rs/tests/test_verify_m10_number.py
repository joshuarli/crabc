"""Focused semantic-proof tests for the M10 integer-parser verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_m10_number", ROOT / "compat" / "crabc-rs" / "verify_m10_number.py"
)
...
class VerifyM10NumberTests(unittest.TestCase):
    ...
    def test_rejects_non_aarch64_or_missing_native_entrypoint(self) -> None:
        with self.assertRaisesRegex(VERIFY.VerificationError, "AArch64"):
            VERIFY.inspect("Machine: x86-64", "", "entry crabc_rs_m10_number_direct_probe")
