"""Focused semantic-proof tests for the M10 native-ctype verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_m10_ctype", ROOT / "compat" / "crabc-rs" / "verify_m10_ctype.py"
)
...
class VerifyM10CtypeTests(unittest.TestCase):
    ...
    def test_rejects_ctype_locale_wide_errno_and_allocator_symbols(self) -> None:
