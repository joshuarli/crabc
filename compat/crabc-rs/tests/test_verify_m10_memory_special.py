"""Focused semantic-proof tests for the M10 special-memory verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_m10_memory_special",
    ROOT / "compat" / "crabc-rs" / "verify_m10_memory_special.py",
)
...
class VerifyM10MemorySpecialTests(unittest.TestCase):
    def test_accepts_aarch64_native_entrypoint_without_forbidden_symbols(self) -> None:
        report = VERIFY.inspect(
            "Machine: AArch64",
            "",
            "0000000000000000 T crabc_rs_m10_memory_special_direct_probe\n",
        )
    ...
    def test_rejects_memory_allocator_and_errno_symbols(self) -> None:
