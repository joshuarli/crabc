...
SCRIPT = ROOT / "compat/crabc-rs/verify_m3.py"
SPEC = importlib.util.spec_from_file_location("verify_m3", SCRIPT)
...
class InspectionTests(unittest.TestCase):
    ...
    def test_rejects_public_abi_errno_or_missing_m3_syscall(self) -> None:
