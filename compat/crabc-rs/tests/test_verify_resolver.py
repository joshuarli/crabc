"""Focused parser tests for the direct-resolver verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_resolver", ROOT / "compat" / "crabc-rs" / "verify_resolver.py"
)
...
class VerifyResolverTests(unittest.TestCase):
