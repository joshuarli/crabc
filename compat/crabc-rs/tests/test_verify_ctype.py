"""Focused semantic-proof tests for the native-ctype verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_ctype", ROOT / "compat" / "crabc-rs" / "verify_ctype.py"
)
