"""Focused semantic-proof tests for the M10 stateful-text verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_m10_text_stateful",
    ROOT / "compat" / "crabc-rs" / "verify_m10_text_stateful.py",
)
...
class VerifyM10TextStatefulTests(unittest.TestCase):
    def test_accepts_aarch64_native_entrypoint_without_forbidden_symbols(self) -> None:
        report = VERIFY.inspect(
            "Machine: AArch64",
            "",
            "0000000000000000 T crabc_rs_m10_text_stateful_direct_probe\n",
        )
