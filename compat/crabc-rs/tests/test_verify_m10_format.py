"""Focused semantic-proof tests for the M10 bounded-formatting verifier."""
...
SPEC = importlib.util.spec_from_file_location(
    "verify_m10_format", ROOT / "compat" / "crabc-rs" / "verify_m10_format.py"
)
...
class VerifyM10FormatTests(unittest.TestCase):
    ...
    def test_rejects_c_formatting_errno_and_allocator_symbols(self) -> None:
