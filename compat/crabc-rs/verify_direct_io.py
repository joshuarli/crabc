#!/usr/bin/env python3
"""Verify that the native fixture stays off crabc's public C ABI.

The caller builds the no-std ``direct_io_probe`` static library for native
...
def fixture_archive(target_dir: Path) -> Path:
    archive = target_dir / "release" / "examples" / "libdirect_io_probe.a"
