//! Common source fixture for the direct Rust boundary.
//!
...
fn main() {
    ...
    let missing = openat(
        CWD,
        cstr(b"/crabc-rs-io-dual-backend-missing\0"),
        OFlags::RDONLY,
        Mode::empty(),
    )
    ...
    assert_eq!(write(&sink, b"io").expect("write directly"), 2);
