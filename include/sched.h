 ...
 * without inventing a separate x86-only public representation. The CPU-set
 * construction/allocation/comparison spellings below are exact header syntax:
 * their `calloc`, `free`, `memcmp`, and `memset` references do not select
 * allocator, byte-string, affinity, or scheduler runtime ownership. */
