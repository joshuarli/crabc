/*
 * Linux/x86-64 syscall-number surface from pinned musl 1.2.6.
 * Source: musl v1.2.6 `arch/x86_64/bits/syscall.h`
 * (9fa28ece75d8a2191de7c5bb53bed224c5947417).
 *
 * This source-only header intentionally owns the complete paired __NR_* and
 * SYS_* macro surface (384 of each) in the upstream source order. Keep the
 * numeric definitions exact: the x86 syscall-number namespace differs from
 * AArch64 and is checked as a complete macro set by
 * compat/x86_64/x86_syscall_header_probe.c.
 *
 * It is included through <sys/syscall.h> only for the staged native
 * little-endian LP64 x86-64 target. It does not select crabc-libc or provide
 * syscall behavior.
 */
#if !defined(__x86_64__) || !defined(__LP64__) || \
	!defined(__BYTE_ORDER__) || !defined(__ORDER_LITTLE_ENDIAN__) || \
	__BYTE_ORDER__ != __ORDER_LITTLE_ENDIAN__
#error "crabc x86-64 syscall numbers require little-endian LP64"
#endif
