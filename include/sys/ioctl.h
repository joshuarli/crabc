...
/* Musl keeps the line-discipline and interface-request vocabulary in this
 * public header; the generic request composition and terminal/FIO constants
 * are owned by the target bits header below. */
#define N_TTY 0
#define N_SLIP 1
#define N_MOUSE 2
#define N_PPP 3
