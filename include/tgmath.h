/* Pinned musl 1.2.6 public <tgmath.h> contract (MIT; release commit
 * 9fa28ece75d8a2191de7c5bb53bed224c5947417). Its GNU type-selection
 * machinery is public behavior: it selects scalar/complex ABI symbols while
 * evaluating each caller expression once. */
#ifndef _TGMATH_H
#define _TGMATH_H
