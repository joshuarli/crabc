...
const M4_PROCESS_ESRCH: c_int = 3;
...
const M4_CLOCK_THREAD_CPUTIME_ID: c_int = 6;
...
#[cfg(target_arch = "x86_64")]
const M4_SYS_SCHED_SETPARAM: i64 = 142;
#[cfg(target_arch = "x86_64")]
const M4_SYS_SCHED_GETPARAM: i64 = 143;
#[cfg(target_arch = "x86_64")]
const M4_SYS_SCHED_SETSCHEDULER: i64 = 144;
#[cfg(target_arch = "x86_64")]
const M4_SYS_SCHED_GETSCHEDULER: i64 = 145;

#[cfg(any(target_arch = "aarch64", target_arch = "riscv64"))]
const M4_SYS_SCHED_SETPARAM: i64 = 118;
#[cfg(any(target_arch = "aarch64", target_arch = "riscv64"))]
const M4_SYS_SCHED_SETSCHEDULER: i64 = 119;
#[cfg(any(target_arch = "aarch64", target_arch = "riscv64"))]
const M4_SYS_SCHED_GETSCHEDULER: i64 = 120;
#[cfg(any(target_arch = "aarch64", target_arch = "riscv64"))]
...
pub unsafe extern "C" fn waitid(
    ...
    syscall_result(m4_waitid(idtype, id, info, options)) as c_int
}
...
#[inline]
unsafe fn m4_pthread_thread_tid(thread: PthreadT) -> Result<c_int, c_int> {
    if thread == 0 {
        return Err(M4_PROCESS_ESRCH);
    }
...
pub unsafe extern "C" fn pthread_getcpuclockid(
    ...
    let tid = match m4_pthread_thread_tid(thread) {
        Ok(tid) => tid,
    ...
    let id = (0u32
        ...
        .wrapping_sub(1)
        .wrapping_shl(3)
        | M4_CLOCK_THREAD_CPUTIME_ID as u32) as c_int;
