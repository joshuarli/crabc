...
// Musl's `src/search/tsearch.c` object.
static_archive_member! { tsearch_source {
...
// Musl's `src/search/tfind.c` object.
static_archive_member! { tfind_source {
...
// Musl's `src/search/tdelete.c` object.
static_archive_member! { tdelete_source {
...
// Musl's `src/search/twalk.c` object.
static_archive_member! { twalk_source {
...
// Musl's `src/search/tdestroy.c` object.
static_archive_member! { tdestroy_source {
