...
// Musl's `src/misc/get_current_dir_name.c` object.
static_archive_member! { get_current_dir_name_source {
...
// Musl's `src/linux/mount.c` object.
static_archive_member! { mount_source {
...
// Musl's `src/termios/tcdrain.c` object.
static_archive_member! { tcdrain_source {
...
// Musl's `src/linux/vhangup.c` object.
static_archive_member! { vhangup_source {
...
// Musl's `src/linux/vmsplice.c` object.
static_archive_member! { vmsplice_source {
...
// Musl's `src/legacy/isastream.c` object.
static_archive_member! { isastream_source {
