//! Private static Linux/x86-64 binary32/binary64 `log10` C ABI leaf.
//!
//! `math_log10_musl_x86_64.S` is a checked assembly translation of pinned musl
//! 1.2.6 release commit `9fa28ece75d8a2191de7c5bb53bed224c5947417`, from the
//! release archive with SHA-256
//! `d585fd3b613c66151fc3249e8ed44f77020cb5e6c1e635a616d3f9f82460512a`.
//! `compat/x86_64/generate_libc_math_log10.py` verifies the normalized complete
...
//!
//! - `src/math/log10.c` retains musl's binary64 raw classification, subnormal
//!   scaling, reduction, split `log10(2)`/`1/log(10)` reconstruction,
//!   polynomial, and IEEE zero/negative domain arithmetic.
//! - `src/math/log10f.c` retains its distinct binary32 constants, raw masks,
//!   subnormal scaling, polynomial, and domain arithmetic rather than
//!   promoting the public `float` boundary.
//!
...
//! direction and IEEE flags—including divide-by-zero for signed zero and
//! invalid for negative finite inputs—without selecting a fenv API or rounding
...
//! `log10l` is representation-distinct and remains outside this leaf; neither
...
compile_error!("the x86 static log10 leaf requires little-endian Linux/x86-64");
