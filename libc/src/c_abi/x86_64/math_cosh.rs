//! Private static Linux/x86-64 binary32/binary64 `cosh`/`coshf` C ABI leaf.
//!
//! `math_cosh_musl_x86_64.S` is a checked assembly translation of pinned musl
//! 1.2.6 release commit `9fa28ece75d8a2191de7c5bb53bed224c5947417`, from the
//! release archive with SHA-256
//! `d585fd3b613c66151fc3249e8ed44f77020cb5e6c1e635a616d3f9f82460512a`.
//! `compat/x86_64/generate_libc_math_cosh.py` verifies the normalized complete
...
//!
//! - `src/math/cosh.c` and `src/math/coshf.c` retain musl's raw magnitude
//!   classification, exact tiny-input one result with inexact evaluation,
//!   stable `expm1` reconstruction, reciprocal exponential reconstruction,
...
//!   closure called only by the local reconstruction path.
//!
...
//!
//! System V AMD64 passes and returns binary64 or binary32 in `xmm0`. `coshl`,
//! `sinh*`, `tanh*`, public exp/expm1 families, direct/inverse trigonometry,
...
compile_error!("the x86 static cosh leaf requires little-endian Linux/x86-64");

musl_object_assembly!("math_cosh_musl_x86_64");
