...
// Musl's `src/linux/name_to_handle_at.c` object.
static_archive_member! { name_to_handle_at_source {
...
// Musl's `src/linux/open_by_handle_at.c` object.
static_archive_member! { open_by_handle_at_source {
