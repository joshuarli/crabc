...
// Musl's `src/linux/epoll.c` object.
static_archive_member! { epoll_source {
...
// Musl's `src/linux/eventfd.c` object.
static_archive_member! { eventfd_source {
...
// Musl's `src/linux/inotify.c` object.
static_archive_member! { inotify_source {
