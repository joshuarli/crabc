...
// Musl's `src/mq/mq_close.c` object.
static_archive_member! { mq_close_source {
...
// Musl's `src/mq/mq_unlink.c` object.
static_archive_member! { mq_unlink_source {
...
static_archive_member! { mq_send_source {
...
static_archive_member! { mq_receive_source {
...
static_archive_member! { mq_timedsend_source {
...
// Musl's `src/mq/mq_timedreceive.c` object.
static_archive_member! { mq_timedreceive_source {
...
// Musl's `src/mq/mq_notify.c` object.
static_archive_member! { mq_notify_source {
