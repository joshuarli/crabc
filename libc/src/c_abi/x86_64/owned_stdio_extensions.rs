...
// Musl's `src/stdio/ext.c` object.
static_archive_member! { ext_source {
    /// # Safety
...
// Musl's `src/stdio/ext2.c` object.
static_archive_member! { ext2_source {
    /// # Safety
    /// The caller exclusively accesses a live FILE and its buffer state.
    #[no_mangle]
...
// Musl's `src/stdio/fgetln.c` object.
static_archive_member! { fgetln_source {
...
// Musl's `src/stdio/gets.c` object.
static_archive_member! { gets_source {
...
// Musl's `src/stdio/getw.c` object.
static_archive_member! { getw_source {
...
// Musl's `src/stdio/putw.c` object.
static_archive_member! { putw_source {
    /// # Safety
...
// Musl's `src/stdio/setbuf.c` object.
static_archive_member! { setbuf_source {
    /// # Safety
...
// Musl's `src/stdio/setbuffer.c` object.
static_archive_member! { setbuffer_source {
    /// # Safety
...
// Musl's `src/stdio/setlinebuf.c` object.
static_archive_member! { setlinebuf_source {
    /// # Safety
...
// Musl's `src/stdio/__uflow.c` object.
static_archive_member! { uflow_source {
...
// Musl's `src/stdio/__overflow.c` object.
static_archive_member! { overflow_source {
