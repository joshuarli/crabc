...
use super::{errno, stderr, StreamGuard};
use super::super::stdio_format_scan::fprintf;
use super::super::strsignal::strsignal;
...
static_archive_member! { psignal_source {
    ...
    pub unsafe extern "C" fn psignal(signal: c_int, message: *const c_char) {
        unsafe {
            let stream = stderr;
            let description = strsignal(signal);
