...
// Musl's `src/misc/pty.c` object.
static_archive_member! { pty_source {
...
// Musl's `src/misc/ptsname.c` object.
static_archive_member! { ptsname_source {
...
// Musl's `src/unistd/ttyname.c` object.
static_archive_member! { ttyname_source {
...
// Musl's `src/termios/tcgetsid.c` object.
static_archive_member! { tcgetsid_source {
...
// Musl's `src/misc/openpty.c` object.
static_archive_member! { openpty_source {
...
// Musl's `src/misc/login_tty.c` object.
static_archive_member! { login_tty_source {
...
// Musl's `src/misc/forkpty.c` object.
static_archive_member! { forkpty_source {
