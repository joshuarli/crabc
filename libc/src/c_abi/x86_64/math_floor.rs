//! Selected static Linux/x86-64 `floor`/`floorf` C ABI leaf.
//!
//! ## Fixed source and license provenance
//!
//! `math_floor_musl_x86_64.S` is a checked assembly translation of pinned musl
//! 1.2.6 release commit `9fa28ece75d8a2191de7c5bb53bed224c5947417`, from the
//! release archive whose SHA-256 is
//! `d585fd3b613c66151fc3249e8ed44f77020cb5e6c1e635a616d3f9f82460512a`.
//! `compat/x86_64/generate_libc_math_floor.py` verifies the normalized source
//! tree digest and the pinned GCC 15.2.0 input before translating exactly
//! `src/math/floor.c` and `src/math/floorf.c`. Those musl-authored MIT files
...
//! rounding direction produces a fixed mathematical floor; the differential
...
//! leaf deliberately owns only `floor` and `floorf`; it excludes binary80
//! `floorl`, ceiling, fma, fmod, cbrt, special and complex math, fenv
//! API/policy, general libm, family completion, promotion, and public x86 support.

#[cfg(not(all(target_os = "linux", target_arch = "x86_64", target_endian = "little")))]
compile_error!("the x86 math floor leaf requires little-endian Linux/x86-64");
