...
// Musl's `src/time/times.c` object.
static_archive_member! { times_source {
...
// Musl's `src/linux/adjtimex.c` object.
static_archive_member! { adjtimex_source {
    ...
    pub unsafe extern "C" fn adjtimex(state: *mut Timex) -> c_int {
        ...
        unsafe { crate::x86_64_static_c_abi::clock_adjtime::clock_adjtime(CLOCK_REALTIME, state.cast::<c_void>()) }
    }
}}

// Musl's `src/linux/adjtime.c` object.
static_archive_member! { adjtime_source {
...
// Musl's `src/linux/settimeofday.c` object.
static_archive_member! { settimeofday_source {
    ...
    pub unsafe extern "C" fn settimeofday(
        ...
        unsafe {
            crate::x86_64_static_c_abi::clock_settime::clock_settime(
                CLOCK_REALTIME,
...
// Musl's `src/linux/stime.c` object.
static_archive_member! { stime_source {
