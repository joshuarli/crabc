...
// Musl's `src/unistd/getgroups.c` object.
static_archive_member! { getgroups_source {
...
// Musl's `src/misc/getresuid.c` object.
static_archive_member! { getresuid_source {
...
// Musl's `src/misc/getresgid.c` object.
static_archive_member! { getresgid_source {
