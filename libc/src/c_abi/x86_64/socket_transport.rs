...
// Musl's `src/network/socket.c` object.
static_archive_member! { socket_source {
...
// Musl's `src/network/socketpair.c` object.
static_archive_member! { socketpair_source {
...
// Musl's `src/network/bind.c` object.
static_archive_member! { bind_source {
...
// Musl's `src/network/listen.c` object.
static_archive_member! { listen_source {
...
// Musl's `src/network/accept.c` object.
static_archive_member! { accept_source {
...
// Musl's `src/network/accept4.c` object.
static_archive_member! { accept4_source {
...
// Musl's `src/network/connect.c` object.
static_archive_member! { connect_source {
...
// Musl's `src/network/send.c` object.
static_archive_member! { send_source {
...
// Musl's `src/network/recv.c` object.
static_archive_member! { recv_source {
...
// Musl's `src/network/sendto.c` object.
static_archive_member! { sendto_source {
...
// Musl's `src/network/recvfrom.c` object.
static_archive_member! { recvfrom_source {
...
// Musl's `src/network/shutdown.c` object.
static_archive_member! { shutdown_source {
...
// Musl's `src/network/getsockname.c` object.
static_archive_member! { getsockname_source {
...
// Musl's `src/network/getpeername.c` object.
static_archive_member! { getpeername_source {
