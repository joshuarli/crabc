...
// Musl's `src/misc/getrlimit.c` object.
static_archive_member! { getrlimit_source {
...
// Musl's `src/misc/setrlimit.c` object.
static_archive_member! { setrlimit_source {
...
// Musl's `src/linux/prlimit.c` object.
static_archive_member! { prlimit_source {
...
// Musl's `src/misc/getrusage.c` object.
static_archive_member! { getrusage_source {
...
// Musl's `src/misc/getpriority.c` object.
static_archive_member! { getpriority_source {
...
// Musl's `src/misc/setpriority.c` object.
static_archive_member! { setpriority_source {
...
// Musl's `src/unistd/nice.c` object.
static_archive_member! { nice_source {
