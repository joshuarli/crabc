...
// Musl's `src/thread/pthread_getschedparam.c` object.
static_archive_member! { pthread_getschedparam_source {
...
// Musl's `src/thread/pthread_setschedparam.c` object.
static_archive_member! { pthread_setschedparam_source {
...
// Musl's `src/thread/pthread_setschedprio.c` object.
static_archive_member! { pthread_setschedprio_source {
