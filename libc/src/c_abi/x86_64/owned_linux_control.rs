...
// Musl's `src/unistd/acct.c` object.
static_archive_member! { acct_source {
...
// Musl's `src/linux/cap.c` object.
static_archive_member! { cap_source {
...
// Musl's `src/linux/module.c` object.
static_archive_member! { module_source {
...
// Musl's `src/linux/fanotify.c` object.
static_archive_member! { fanotify_source {
...
// Musl's `src/linux/klogctl.c` object.
static_archive_member! { klogctl_source {
...
// Musl's `src/linux/pivot_root.c` object.
static_archive_member! { pivot_root_source {
...
// Musl's `src/linux/quotactl.c` object.
static_archive_member! { quotactl_source {
...
// Musl's `src/linux/reboot.c` object.
static_archive_member! { reboot_source {
...
// Musl's `src/linux/setns.c` object.
static_archive_member! { setns_source {
...
// Musl's `src/linux/swap.c` object.
static_archive_member! { swap_source {
...
// Musl's `src/linux/unshare.c` object.
static_archive_member! { unshare_source {
...
// Musl's `src/linux/process_vm.c` object.
static_archive_member! { process_vm_source {
...
// Musl's `src/linux/ptrace.c` object.
static_archive_member! { ptrace_source {
