...
// Musl's `src/time/localtime_r.c` object.
static_archive_member! { localtime_r_source {
...
// Musl's `src/time/mktime.c` object.
static_archive_member! { mktime_source {
...
// Musl's `src/time/localtime.c` object.
static_archive_member! { localtime_source {
...
// Musl's `src/time/gmtime.c` object.
static_archive_member! { gmtime_source {
...
// Musl's `src/time/asctime_r.c` object.
static_archive_member! { asctime_r_source {
    // The source keeps this provider hidden; the directive applies to its definition here.
    core::arch::global_asm!(
        ".hidden __asctime_r",
    );
...
// Musl's `src/time/asctime.c` object.
static_archive_member! { asctime_source {
...
// Musl's `src/time/ctime.c` object.
static_archive_member! { ctime_source {
...
// Musl's `src/time/ctime_r.c` object.
static_archive_member! { ctime_r_source {
