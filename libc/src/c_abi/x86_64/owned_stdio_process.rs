...
//! No public atfork callback runs in a spawn child. Deferred cancellation and
//! the shared process-creation/SIGABRT lock are owned by the common spawn seam;
//! syscall cancellation remains a separate pthread runtime obligation.
