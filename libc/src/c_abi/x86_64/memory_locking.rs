...
// Musl's `src/mman/mlock.c` object.
static_archive_member! { mlock_source {
...
// Musl's `src/mman/munlock.c` object.
static_archive_member! { munlock_source {
...
// Musl's `src/linux/mlock2.c` object.
static_archive_member! { mlock2_source {
