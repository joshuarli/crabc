// M4 integer and NaN utility entry points.
//
...
#[no_mangle]
pub unsafe extern "C" fn imaxdiv(numerator: c_long, denominator: c_long) -> M4ImaxDiv {
    M4ImaxDiv {
...
#[inline]
unsafe fn m4_rand_r_temper(mut value: c_uint) -> c_uint {
    value ^= value >> 11;
...
pub unsafe extern "C" fn rand_r(seed: *mut c_uint) -> c_int {
    *seed = (*seed).wrapping_mul(1103515245).wrapping_add(12345);
    (m4_rand_r_temper(*seed) >> 1) as c_int
}
