...
const INPUT_PATH: &[u8] = b"/tmp/crabc-rs-native-sendfile-input";
const OUTPUT_PATH: &[u8] = b"/tmp/crabc-rs-native-sendfile-output";
const INVALID_PATH: &[u8] = b"/tmp/crabc-rs-native-sendfile-invalid";
