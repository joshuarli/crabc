//! Native, allocation-free filename pattern matching for staged Linux/x86-64.
//!
//! This deliberately admits only the pure direct matcher. The allocation-backed
//! `glob` and `glob_at` traversal APIs retain their separate AArch64 filesystem
//! contract and are not exposed from this module.
