//! Link-free assembly probe for the direct core-OS boundary.
//!
...
#[no_mangle]
pub extern "C" fn crabc_rs_core_os_probe() -> i32 {
    ...
    if let Err(error) = net::send(&sender, b"os", net::SendFlags::empty()) {
        return -error.raw();
    }
