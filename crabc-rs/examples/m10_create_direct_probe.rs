//! Link-free no-std proof for the M10 native `creat` seam.
//!
...
#[no_mangle]
pub extern "C" fn crabc_rs_m10_create_direct_probe() -> i32 {
    // SAFETY: The byte string is static, non-null, and NUL-terminated.
    let path = unsafe { CStr::from_bytes_with_nul_unchecked(b"/tmp/crabc-rs-m10-create-probe\0") };
