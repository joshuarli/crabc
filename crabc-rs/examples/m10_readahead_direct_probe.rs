//! Link-free no-std proof for the M10 native `readahead` seam.
//!
...
const PATH: &[u8] = b"/tmp/crabc-rs-m10-readahead-probe";
...
#[no_mangle]
pub extern "C" fn crabc_rs_m10_readahead_direct_probe() -> i32 {
