//! Unregistered no-std release probe for the special-node syscall seam.
//!
...
#[no_mangle]
pub extern "C" fn crabc_rs_special_nodes_direct_probe() -> i32 {
    // SAFETY: The byte string is static, non-null, and NUL-terminated.
    let path = unsafe {
        CStr::from_bytes_with_nul_unchecked(b"/tmp/crabc-rs-native-special-nodes-probe\0")
    };
