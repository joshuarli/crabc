//! Link-free no-std proof for the native `sync_file_range` seam.
//!
...
const PATH: &[u8] = b"/tmp/crabc-rs-native-sync-file-range-probe";
...
#[no_mangle]
pub extern "C" fn crabc_rs_sync_file_range_direct_probe() -> i32 {
