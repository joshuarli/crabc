...
const DSO: &CStr = unsafe { CStr::from_bytes_with_nul_unchecked(b"libm11_loader_introspection.so\0") };
...
#[no_mangle]
pub extern "C" fn crabc_rs_m11_loader_dlfcn_introspection_probe() -> i32 {
