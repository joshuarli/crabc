//! Runtime proof for the bounded native dynamic-loader slice.
//!
...
const DROP_STATE: &CStr =
    unsafe { CStr::from_bytes_with_nul_unchecked(b"loader_dlfcn_drop_state\0") };
const MISSING_SYMBOL: &CStr =
    unsafe { CStr::from_bytes_with_nul_unchecked(b"loader_dlfcn_missing_symbol\0") };
const MISSING_DSO: &CStr =
    unsafe { CStr::from_bytes_with_nul_unchecked(b"libloader_dlfcn_missing.so\0") };
...
#[no_mangle]
pub extern "C" fn crabc_rs_loader_dlfcn_basic_probe() -> i32 {
