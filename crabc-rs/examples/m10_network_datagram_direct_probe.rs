//! Link-free no-std proof for the M10 native addressed-datagram seam.
//!
...
#[no_mangle]
pub extern "C" fn crabc_rs_m10_network_datagram_direct_probe() -> i32 {
