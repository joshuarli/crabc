//! Link-free no-std proof for the M10 native vectored message seam.
//!
...
#[no_mangle]
pub extern "C" fn crabc_rs_m10_network_messages_direct_probe() -> i32 {
    ...
    let payload = [io::IoSlice::new(b"m10-"), io::IoSlice::new(b"probe")];
