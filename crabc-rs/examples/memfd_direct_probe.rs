//! Link-free no-std proof for the native memfd-create seam.
//!
...
#[no_mangle]
pub extern "C" fn crabc_rs_memfd_direct_probe() -> i32 {
    let file = match fs::memfd_create(&b"crabc-native-probe"[..], MemfdFlags::CLOEXEC) {
        Ok(file) => file,
