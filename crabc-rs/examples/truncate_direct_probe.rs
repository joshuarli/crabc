//! Link-free no-std proof for the native pathname `truncate` seam.
//!
...
const PATH: &[u8] = b"/tmp/crabc-rs-native-truncate-probe";
...
#[no_mangle]
pub extern "C" fn crabc_rs_truncate_direct_probe() -> i32 {
