//! Link-free no-std proof for the M10 native fallocate seam.
//!
...
#[no_mangle]
pub extern "C" fn crabc_rs_m10_fallocate_direct_probe() -> i32 {
    let path = &b"/tmp/crabc-rs-m10-fallocate-probe"[..];
