//! Link-free no-std proof for the M10 direct file-ownership slice.
//!
...
#[no_mangle]
pub extern "C" fn crabc_rs_m10_ownership_direct_probe() -> i32 {
    // SAFETY: This static byte string is non-null and NUL-terminated.
    let missing = unsafe {
        CStr::from_bytes_with_nul_unchecked(b"/crabc-rs-m10-ownership-no-such-entry\0")
    };
