//! Link-free assembly probe for the M5 direct Linux/AArch64 boundary.
//!
...
#[no_mangle]
pub extern "C" fn crabc_rs_m5_direct_probe() -> i32 {
    let file = match fs::open(
        "/tmp/crabc-rs-m5-static-probe",
