//! Link-free assembly probe for the M2 direct filesystem boundary.
//!
//! This no-std static library monomorphizes representative M2 filesystem
...
#[no_mangle]
pub extern "C" fn crabc_rs_m2_direct_probe() -> i32 {
    ...
    let _ = fs::fsetxattr(&directory, attribute, b"M2", XattrFlags::empty());
