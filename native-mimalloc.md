...
current closure gate; its current clean native evidence has 31 selected checks
(eight VM-primitives, six metadata, two bitmap C/Rust differentials, ten
